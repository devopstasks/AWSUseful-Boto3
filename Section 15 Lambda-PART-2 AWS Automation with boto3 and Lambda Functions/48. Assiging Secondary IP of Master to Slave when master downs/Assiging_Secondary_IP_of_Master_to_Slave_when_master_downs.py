'''
Automatically Assign Secondary IP of Master to Slave when Master downs
(How to create a server failover solution?)

Lambda function name= AutoAssignSecIPtoSlaveWhenMasterDown
'''
...
def lambda_handler(event,context):
	master_id="i-0aca754c77390c67"
	slave_id="i-0d26g77723j21c345"
